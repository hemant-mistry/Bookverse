                    ...
                    <div className="filter-section flex flex-col items-start justify-center ">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center mb-4">
                                <input id="fiction-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                <label htmlFor="fiction-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fiction</label>
                            </div>
                    ...
                    <div className="top-users-panel">
                        ...
                        {topUsers.map((user, index) => (
                            <div key={index} className="flex items-center mb-4">
                                ...
                                <span className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{user.name}</span>
                            </div>
                        ))}
                    </div>
                </div>
